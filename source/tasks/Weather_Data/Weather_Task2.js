  ...
  var chartWidth = window.innerWidth * 0.8; var chartHeight = window.innerHeight * 0.65; var chartBorderWidth = "15px";
  ...
  function ChartHandler()
  {
    this.initialize = function(ctx, chartLabel, dateList, dataList, graphBgCol, graphBorderCol)
    {
      ...
      this.chartCtx.style.width = window.innerWidth;
      this.chartCtx.style.height = window.innerHeight;
      this.chartCtx.style.backgroundColor = 'gainsboro';
      this.chartCtx.style.borderStyle = "solid";
      this.chartCtx.style.borderWidth = "5px";
      this.chartCtx.style.borderColor = "blaxk";
